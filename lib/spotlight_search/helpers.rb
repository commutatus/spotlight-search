module SpotlightSearch
  module Helpers
    ...
    def column_pop_up(email, tenant_name, klass, required_filters = nil)
      tag.div class: "modal fade", id: "exportmodal", tabindex: "-1", role: "dialog", aria: {labelledby: "exportModal"} do
        tag.div class: "modal-dialog modal-lg", role: "document" do
          tag.div class: "modal-content" do
            concat pop_ups(email, tenant_name, klass, required_filters)
          end
        end
      end
    end

    def pop_ups(email, tenant_name, klass, required_filters)
      tag.div do
        concat pop_up_header
        concat pop_up_body(email, tenant_name, klass, required_filters)
      end
    end
    ...
    def pop_up_body(email, tenant_name, klass, required_filters)
      tag.div class: "modal-body" do
        form_tag '/spotlight_search/export_to_file', id: 'export-to-file-form', style: "width: 100%;", class:"spotlight-csv-export-form" do
          ...
          concat hidden_field_tag 'tenant_name', tenant_name.to_s, id: 'export-to-tenant-name'
